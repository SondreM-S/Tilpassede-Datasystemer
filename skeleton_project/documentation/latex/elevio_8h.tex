...
\begin{DoxyCompactList}\small\item\em Sets motor direction of the elevator. \end{DoxyCompactList}\item 
...
Sets motor direction of the elevator. 


\begin{DoxyParams}{Parameters}
{\em dirn} & Takes input parameter of the direction of the elevator (-\/1 is down, 0 is stop, 1 is up) \\
\hline
\end{DoxyParams}
